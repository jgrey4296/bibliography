...
see taskcode.metadata.genbibtentrytask
...
*** [⟙] pre
- State "[⟙]"        from "[∅]"        [2024-07-29 Mon 23:26]
*** TODO post
**** [∅] get changed files using git diff
**** [∅] trigger changed::_.one.bib
**** DEAD export changed bibs
superceded by changed::_one.bib
**** DEAD build  changed bibs
superceded by changed::_one.bib
**** [∅] fixup metadata
superceded by changed::_one.bib
**** [∅] backup new files
...
:END:
*** DONE git cache collection
- State "DONE"       from              [2024-07-29 Mon 23:33]
*** [∅] tag extraction
