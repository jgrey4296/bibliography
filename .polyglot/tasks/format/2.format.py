...
TAG_ROOT        : Final[pl.Path]    = pl.Path(environ['BIBLIO_TAGS_LOC'])
LIB_ROOT        : Final[pl.Path]    = pl.Path(environ['BIBLIO_LIB'])
SUB_ROOT        : Final[pl.Path]    = TAG_ROOT / "tags/substitutions"
TAGS_SOURCE     : Final[pl.Path]    = TAG_ROOT / ".temp/tags/canon.tags"
